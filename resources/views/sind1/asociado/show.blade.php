...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <div class="card">
                <div class="card-header text-center"><h3 class="mb-0">Eliminar Asociado</h3></div>
                ...
                <div class="card-body shadow-lg p-3 bg-white rounded">
                    ...
                    <form class="text-center" method="POST" action="{{ route('asociados.destroy', $asociado) }}">
                        ...
                        <a class="btn btn-secondary" href="{{ route('mantenedor_contable_asociado') }}" role="button">Cancelar</a>
