        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body shadow-lg p-3 bg-white rounded">
                    ...
                    @else
                        <div>
                            @include('partials.components.filtros.estadistica_estudios')
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    @foreach($socios as $s)
                                        <tr>
                                            <td width="50" class="text-center" scope="row" title="Ver detalle socio"><a class="text-primary" href="{{ route('socios.show',$s->socio_id) }}"><span>@svg('ver')</span></a></td>
                                            <td width="50" class="text-center" scope="row" title="Editar socio"><a class="text-secondary" href="{{ route('socios.edit',$s->socio_id) }}"><span>@svg('editar')</span></a></td>
                                            <td width="50" class="text-center" scope="row" title="Eliminar socio"><a class="text-danger" href="{{ route('eliminar_socio_form',$s->socio_id) }}"><span>@svg('eliminar')</span></a></td>
