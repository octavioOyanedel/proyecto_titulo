        ...
        <div class="col-md-7">
            ...
            <div class="card">
                ...
                <div class="card-body shadow-lg p-3 bg-white rounded">
                    ...
                    <p class="text-center">¿Desea continuar con la eliminación de este banco <b>{{ $banco->nombre }}</b>?</p>
                    <!-- Formulario -->
                    <form class="text-center" method="POST" action="{{ route('bancos.destroy', $banco) }}">
                        ...
                        <a class="btn btn-secondary" href="{{ route('mantenedor_contable_banco') }}" role="button">Cancelar</a>
