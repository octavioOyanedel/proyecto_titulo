        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body shadow-lg p-3 bg-white rounded">
                    ...
                    <a class="btn btn-outline-primary active" href="{{ route('mantenedor_contable_tipo_cuenta') }}" role="button">Tipo de Cuenta</a>
                    <a class="btn btn-outline-primary" href="{{ route('mantenedor_contable_asociado') }}" role="button">Asociado</a>

                    <div>
                        <a class="btn btn-success mt-4 mb-4" href="{{ route('tipos_cuentas.create') }}">Agregar Tipo de Cuenta</a>  
                    </div>
