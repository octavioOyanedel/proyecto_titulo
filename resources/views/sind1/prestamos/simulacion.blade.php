                            ...
                            <table id="tabla_datos_laborales" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center centrar-td">Estado</th>
                                    </tr>
                                </thead>     
                                <tbody>
                                    @foreach($cuotas as $c)
                                    ...
                                    <tr>
                                        ...
                                        @else 
                                            <th class="text-right centrar-td" colspan="3">Total</th>
                                            <th class="text-center centrar-td">{{ formatoMoneda($request->monto) }}</th>
                                        @endif                                                                       
                                    </tr>
                                </tbody>
                            </table>            
