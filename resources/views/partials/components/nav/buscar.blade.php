...
<div id="buscador-sede" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_sede') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de sede(s) por medio de: .">?</button>
...
<div id="buscador-area" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_area') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de área(s) por medio de: .">?</button>
...
<div id="buscador-cargo" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_cargo') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de cargo(s) por medio de: .">?</button>
...
<div id="buscador-estado-socio" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_estado') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de estado por medio de: .">?</button>
...
<div id="buscador-nacionalidad" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_nacionalidad') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de nacionalidad por medio de: .">?</button>
...
<div id="buscador-parentesco" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_carga_parentesco') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de parentesco por medio de: .">?</button>
...
<div id="buscador-nivel" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_estudio_nivel') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de nivel educacional por medio de: .">?</button>
...
<div id="buscador-institucion" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_estudio_institucion') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de institución(es) por medio de: .">?</button>
...
<div id="buscador-estado-nivel" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_estudio_estado_nivel') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de estado(s) nivel académico por medio de: .">?</button>
...
<div id="buscador-titulo" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_estudio_titulo') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de título(s) por medio de: .">?</button>
...
<div id="buscador-pago" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_prestamo_forma_pago') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de forma de pago por medio de: .">?</button>
...
<div id="buscador-cuenta" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_cuenta') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de cuenta(s) bancaria(s) por medio de: .">?</button>
...
<div id="buscador-banco" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_banco') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de banco por medio de: .">?</button>
...
<div id="buscador-concepto" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_concepto') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de concepto(s) por medio de: .">?</button>
...
<div id="buscador-tipo-cuenta" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_tipo_cuenta') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de tipo de cuenta bancaria por medio de: .">?</button>
...
<div id="buscador-asociado" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_asociado') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de asociado(s) por medio de: .">?</button>
