...
<div id="buscador-prestamo" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('prestamos.index') }}">
        ...
        <input class="form-control mr-sm-2" type="search" name="buscar_prestamo" placeholder="Buscar prestamo" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-contable" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('contables.index') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de registro contable por medio de: Fecha de solicitud (Ej. 01-01-2019), Tipo de registro (egreso o ingreso), Número de registro, Concepto, Cheque, Monto (Ej. 20000) y Detalle.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_registro" placeholder="Buscar registro" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-historial" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('historial.index') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de log por medio de: Correo, Fecha (Ej. 01-01-2019), Acción (Cualquiera de las palabras incluidas en esta celda Ej. -concepto- depósito, -cheque- 996699660, -nombre- Juan Soto, o -rut- con formato 11.222.333-k), IP, Navegador y Sistema operativo.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_historial" placeholder="Buscar log" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-usuario" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('usuarios.index') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de usuario por medio de: Nombre (primer o segundo nombre), apellido (paterno o materno), Correo y Rol (Ej. usuario).">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_usuario" placeholder="Buscar usuario" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-sede" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_sede') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de sede por medio de: Sede.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_sede" placeholder="Buscar sede" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-area" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_area') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de área por medio de: Sede y Área.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_area" placeholder="Buscar área" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-cargo" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_socio_cargo') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de cargo por medio de: Cargo.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_cargo" placeholder="Buscar cargo" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-estado-nivel" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_estudio_estado_nivel') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de estado nivel académico por medio de: Estado nivel acádemico.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_estado_nivel" placeholder="Buscar estado" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-titulo" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_estudio_titulo') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de título por medio de: Título.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_titulo" placeholder="Buscar título" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-cuenta" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_cuenta') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de cuenta bancaria por medio de: Número de cuenta (Ej. 001-001-1111).">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_cuenta" placeholder="Buscar cuenta" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
<!-- formulario banco-->
...
<div id="buscador-concepto" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_concepto') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de concepto por medio de: Concepto y Tipo de egreso (ingreso o egreso).">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_concepto" placeholder="Buscar concepto" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-asociado" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('mantenedor_contable_asociado') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de asociado por medio de: Concepto y Nombre de asociado.">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_asociado" placeholder="Buscar asociado" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>
...
<div id="buscador-carga" class="d-none">
    <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('cargas.index') }}">
        <button type="button" class="btn btn-sm btn-outline-primary rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Búsqueda de carga por medio de: Nombre (primer o segundo nombre), apellido (paterno o materno), Rut de carga (Ej. 11222333k), Fecha de nacimiento (Ej. 01-01-2019), Rut de socio (Ej. 11222333k) y parentesco (Ej. hijo).">?</button>
        <input class="form-control mr-sm-2" type="search" name="buscar_carga" placeholder="Buscar carga" aria-label="Search">
        <button class="btn btn-primary my-2 my-sm-0" type="submit">Buscar</button>
    </form>
</div>