    ...
    <form class="form-inline float-right" method="GET" action="{{ route('mantenedor_contable_asociado') }}">
        <div class="input-group mb-2 mr-sm-2">
        ...
        <div class="input-group mb-2 mr-sm-2">
            <select name="columna" id="columna" class="form-control form-control-sm">
                ...
                <option value="concepto" @if(request('columna') === 'concepto') {{ 'selected' }} @endif>Asociado</option>
        ...
        <input type="hidden" name="buscar_asociado" value="{{ request('buscar_asociado') }}">
