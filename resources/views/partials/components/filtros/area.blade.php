    ...
    <form class="form-inline float-right" method="GET" action="{{ route('mantenedor_socio_area') }}">
        <div class="input-group mb-2 mr-sm-2">
        ...
        <div class="input-group mb-2 mr-sm-2">
            <select name="columna" id="columna" class="form-control form-control-sm">
                ...
                <option value="nombre" @if(request('columna') === 'nombre') {{ 'selected' }} @endif>Área</option>    
        ...
        <input type="hidden" name="buscar_area" value="{{ request('buscar_area') }}">
