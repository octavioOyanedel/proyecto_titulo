    ...
    <div class="float-left">
        <div class="input-group mb-2 mr-sm-2">
            ...
            <a title="Exportar listado." class="mr-2" href="{{ route('socios_estudios_estadistica',[
                'nombre' => $nombre
            ]) }}">|<b>Exportar Excel</b>|</a>
        </div>
    </div>
    <form class="form-inline float-right" method="GET" action="{{ route('socios_filtrados_educacion') }}">
        <div class="input-group mb-2 mr-sm-2">
