            ...
            <tbody>
                @foreach($estados as $e)
                    <tr>                                                
                        ...
                        <td class="text-center" scope="row" title="Eliminar estado socio"><a class="text-danger" data-toggle="modal" data-target="#eliminar_estado" href="#"><span>@svg('eliminar')</span></a></td>
