            ...
            <tbody>
                @foreach($nacionalidades as $n)
                    <tr>                                                
                        ...
                        <td class="text-center" scope="row" title="Eliminar nacionalidad"><a class="text-danger" data-toggle="modal" data-target="#eliminar_nacionalidad" href="#"><span>@svg('eliminar')</span></a></td>
