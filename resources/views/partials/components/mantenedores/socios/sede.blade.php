            ...
            <tbody>
                @foreach($sedes as $s)
                    <tr>                                                
                        ...
                        <td width="50" class="text-center" scope="row" title="Eliminar sede"><a id="modal_eliminar_sede" data-id="{{ $s->id }}" class="text-danger" data-toggle="modal" data-target="#eliminar_sede" href="#"><span>@svg('eliminar')</span></a></td>
