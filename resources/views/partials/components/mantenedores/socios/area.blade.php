            ...
            <tbody>
                @foreach($areas as $a)
                    <tr>                                                
                        ...
                        <td class="text-center" scope="row" title="Eliminar área"><a id="modal_eliminar_area" class="text-danger" data-toggle="modal" data-target="#eliminar_area" href="#"><span>@svg('eliminar')</span></a></td>
                        <td>{{ $a->sede_id }}</td>
                        <td>{{ $a->nombre }}</td>
                    </tr>
                @endforeach
