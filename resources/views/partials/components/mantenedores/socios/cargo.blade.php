            ...
            <tbody>
                @foreach($cargos as $c)
                    <tr>                                                
                        ...
                        <td width="50" class="text-center" scope="row" title="Eliminar cargo"><a data-id="{{ $c->id }}" class="enlace_eliminar text-danger" data-toggle="modal" data-target="#eliminar_cargo" href="#"><span>@svg('eliminar')</span></a></td>
