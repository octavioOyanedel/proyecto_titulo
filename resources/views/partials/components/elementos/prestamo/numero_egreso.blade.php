...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="numero_egreso" type="text" class="form-control @error('numero_egreso') is-invalid @enderror" name="numero_egreso" value="{{ old('numero_egreso') == true ? old('numero_egreso') : $numero_egreso }}" required autocomplete="numero_egreso" autofocus maxlength="4">
