...
<div class="form-group row">
    <label for="forma_pago_id" class="col-md-4 col-form-label text-md-right"><span title="Campo obligatorio." class="text-danger"><button type="button" class="btn btn-sm btn-outline-dark rounded-circle mr-2 pb-0" data-container="body" data-toggle="popover" data-placement="left" data-content="Solo método de pago 'Descuento por planilla' involucra registro de cheque.">?</button><b>{{ esObligatorio(request()->path()) }} </b></span>{{ __('Método de pago') }}</label>
    <div class="col-md-6">
