...
<div id="campo_cheque" class="form-group row d-none">
    <label for="cheque" class="col-md-4 col-form-label text-md-right"><span id="obligatorio" title="Campo obligatorio." class="text-danger d-none"><b>{{ esObligatorio(request()->path()) }} </b></span>{{ __('Cheque') }}</label>
    <div class="col-md-6">
        <input id="cheque" type="text" class="form-control @error('cheque') is-invalid @enderror" name="cheque" value="{{ old('cheque') }}" autocomplete="cheque" autofocus maxlength="9" placeholder="Ej. 3210123">
