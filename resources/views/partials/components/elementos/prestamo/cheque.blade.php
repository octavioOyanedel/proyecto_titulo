...
<div id="campo_cheque" class="form-group row">
    ...
    <div class="col-md-6">
        <input id="cheque" type="text" class="form-control @error('cheque') is-invalid @enderror" name="cheque" value="{{ old('cheque') == true ? old('cheque') : $cheque }}" autocomplete="cheque" autofocus maxlength="9" placeholder="Ej. 3210123" required>
