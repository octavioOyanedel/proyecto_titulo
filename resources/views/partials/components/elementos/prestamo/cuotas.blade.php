...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <select id="numero_cuotas" class="default-selects form-control @error('numero_cuotas') is-invalid @enderror" name="numero_cuotas" required autocomplete="numero_cuotas" autofocus>
