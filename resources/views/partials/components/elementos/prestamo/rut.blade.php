...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="rut" type="text" class="form-control @error('rut') is-invalid @enderror" name="rut" value="{{ old('rut') }}" required autocomplete="rut" placeholder="Ej. 138816389" autofocus maxlength="9">
