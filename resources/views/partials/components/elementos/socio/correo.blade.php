...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="correo" type="mail" class="form-control @error('correo') is-invalid @enderror" name="correo" value="{{ old('correo') == true ? old('correo') : $correo }}" required autocomplete="correo" autofocus>
