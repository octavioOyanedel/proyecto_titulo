...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="detalle" type="text" class="form-control @error('detalle') is-invalid @enderror" name="detalle" value="{{ old('detalle') == true ? old('detalle') : $detalle }}" autocomplete="detalle" autofocus>
