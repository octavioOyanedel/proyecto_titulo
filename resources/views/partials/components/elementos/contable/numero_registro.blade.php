...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="numero_registro" type="number" class="form-control @error('numero_registro') is-invalid @enderror" name="numero_registro" value="{{ old('numero_registro') == true ? old('numero_registro') : $numero_registro }}" required autocomplete="numero_registro" autofocus min="1" max="999999" disabled>
