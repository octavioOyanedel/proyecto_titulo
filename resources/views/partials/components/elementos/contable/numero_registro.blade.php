...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="numero_registro" type="text" class="form-control @error('numero_registro') is-invalid @enderror" name="numero_registro" value="{{ old('numero_registro') == true ? old('numero_registro') : $numero_registro }}" required autocomplete="numero_registro" autofocus disabled>
