...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="fecha" type="date" class="form-control @error('fecha') is-invalid @enderror" name="fecha" value="@if(old('fecha')){{old('fecha')}}@elseif(isset($registro)){{ $original_fecha }}@else{{date('Y-m-d')}}@endif" required autocomplete="fecha" autofocus>
