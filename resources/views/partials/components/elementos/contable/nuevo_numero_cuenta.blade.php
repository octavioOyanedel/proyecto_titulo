...
<div class="form-group new-divs row" id="new_div_nation">
    <label for="nuevo_numero_cuenta" class="col-md-4 col-form-label text-md-right"><span title="Campo obligatorio." class="text-danger"><b>* </b></span>{{ __('Número de cuenta') }}</label>
    <div class="col-md-6">
